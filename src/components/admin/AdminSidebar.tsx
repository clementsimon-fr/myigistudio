import { LayoutDashboard, CalendarDays, BookOpen, Users, UserCircle, CreditCard, FileText, Gift, LogOut } from "lucide-react";
    ...
    <Sidebar collapsible="icon">
      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupLabel>
            {!collapsed && (
              <span className="text-sm font-display font-bold text-primary-dark">
                Admin
              </span>
            )}
          </SidebarGroupLabel>
