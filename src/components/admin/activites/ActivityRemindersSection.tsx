...
export function ActivityRemindersSection({ form, setForm }: ActivityRemindersSectionProps) {
  return (
    <div className="space-y-4">
      ...
      <div className="border rounded-lg p-5 space-y-3 bg-card shadow-sm">
        ...
        <TemplateEditor value={form.default_reminder} onChange={v => setForm(prev => ({ ...prev, default_reminder: v }))} variables={REMINDER_VARIABLES} showInsertModalities={true} rows={5} />
