...
import { CalendarDays, CreditCard, Clock, LogOut, Plus } from "lucide-react";
import { mockReservations, mockClientCards } from "@/data/mockData";
...
export default function MonEspace() {
  ...
  const upcomingReservations = mockReservations.filter((r) => r.status !== "annulé").slice(0, 3);
      ...
      <main className="flex-1 py-8">
        <div className="container max-w-4xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            ...
            <div className="rounded-xl border bg-card p-4 text-center">
              <p className="text-2xl font-bold text-primary-dark">{mockReservations.length}</p>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 text-xs text-muted-foreground">
                        <Clock className="h-3 w-3" /> {r.time} · {r.instructor}
                      </div>
                    </div>
                  </div>
